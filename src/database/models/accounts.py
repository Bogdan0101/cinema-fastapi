...
from src.security.email import validate_email
from src.security.token import JWTAuthManager

if TYPE_CHECKING:
    from src.database.models.movies import MovieModel, ReviewModel
...
class UserModel(Base):
    ...
    favorite_movies: Mapped[list["MovieModel"]] = relationship(
        "MovieModel",
        secondary="movie_user_favorites",
...
class TokenBaseModel(Base):
    ...
    token: Mapped[str] = mapped_column(
        ...
        unique=True,
        nullable=False,
        default=JWTAuthManager.generate_secure_token,
    )
